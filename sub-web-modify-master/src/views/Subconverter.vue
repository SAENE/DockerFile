        ...
        <el-card>
          <div slot="header">
            ...
            <svg-icon class="channel" icon-class="telegram" style="float:right;margin-left: 10px"
                      @click="gotoTgChannel"/>
            <div style="text-align:center;font-size:15px">订 阅 转 换 | 本站不负任何责任，不提供任何订阅</div>
          </div>
          <el-container>
...
export default {
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "本站默认": "https://sub.eneziyuan.top/myurls/short",
        ...
        customBackend: {
          "本站默认后端subconverter官方版本": "https://sub.eneziyuan.top",
        ...
        remoteConfig: [
          {
            ...
            options: [
              ...
              {
                label: "本站默认规则基础版",
                value: "CNIX/CNIX-Base.ini"
              },
              {
                label: "本站默认规则(自动选择)",
                value: "CNIX/CNIX-Auto.ini"
              },
              {
                label: "本站默认规则(去广告全分类)",
                value: "CNIX/CNIX-Full.ini"
              },
              {
                label: "本站默认规则(去广告自动选择全分类)",
                value: "CNIX/CNIX-Full-Auto.ini"
              },
              {
                label: "默认",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://sub.eneziyuan.top" : this.getUrlParam(),
        shortType: "https://sub.eneziyuan.top/myurls/short",
        remoteConfig: "CNIX/CNIX.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px">本站不负任何责任</span></strong></br><strong>本站不提供任何订阅</strong></br></br></div>`, '信息面板', {
